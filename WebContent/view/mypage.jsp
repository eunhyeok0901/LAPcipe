...
//  	   				clickcheck1 = false;
   ...
   function showMyNote(){
	...
	function showUser2(){
		memId= '<%=(String)session.getAttribute("loginMember")%>';
		<% DecimalFormat fomatter = new DecimalFormat("###,###"); %>
	console.log(memId,myid);
		$.ajax({
			url : '/rps_mpro/memberView.do',
   			type : 'post',
   			data : {memId : memId},
   			success : function(res){
//    				alert("됐따!");
			    ...
			    code += '<div class="col-sm-4" style="border:none;">';
			    code += '<div class="panel text-center" style="border:none;">';
			    code += '<div class="panel-body" style="border:none;background:#faf8f0;font-size:1.2em;">';  
			    code += '<p><strong>이름: </strong>'+res.mem_id+'</p>';
			    code += '<hr>';
			    code += '<p><strong>닉네임: </strong>'+res.mem_nickname +'</p>';     
			    code += '<hr>';     
			    code += '<p><strong>전화번호: </strong>'+res.mem_tel+'</p>';     
			    code += '<hr>';     
			    code += '<p><strong>주소: </strong>'+res.mem_add+'</p>';
			    code += '<hr>';     
			    code += '<p><strong>이메일: </strong>'+res.mem_email+'</p>';
			    code += '<hr>';     
			    code += '<p><strong>보유포인트: </strong>'+res.mem_point.toLocaleString()+'</p>';
			    code += '<hr>';     
			    code += '<input class="profilebtn1" id="btnAmend" type="button" value="회원정보 수정" data-toggle="modal" data-target="#checkPw">';
			    code += '<input class="profilebtn1" id="btnDelete" type="button" value="회원 탈퇴" data-toggle="modal" data-target="#checkPw2">';
				code += '	        </div>         '    ;
				code += '	      </div>           '    ;
				code += '	    </div>             '    ;
				code += '	  </div>			'		;	
...
<!--   <div class="mycate"><span style="font-size: 1.2em; font-weight: bolder;"class="mydata" onclick="showUser()">내 정보</span></div> -->
  <div class="mycate"><span style="font-size: 1.2em; font-weight: bolder;"class="mydata" onclick="showUser2()">내 정보</span></div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form>
		      <p><textarea cols="50" rows="10" placeholder=""></textarea></p>
