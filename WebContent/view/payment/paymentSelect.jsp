...
<script>
function putvalue(){
	document.getElementById('name').value = '배영호';
	document.getElementById('email').value = 'qodydgh85@naver.com';
	document.getElementById('phone').value = '010-1111-2222';
	document.getElementById('address').value = '대덕인재';
}
...
//	    	console.log(vpay);
		   	var paym = $("select[name=subject] option:selected").val();
		   	 ...
		   	 if(paym == 1){
// 		   		 alert("1개월 결제입니다.");
		   		 $('#totalPrice').val(Math.ceil(<%=cvo.getClass_price()%>*1 / 100)*100);
		   		<%=totalPrice=Integer.parseInt(cvo.getClass_price())*1 %>;
		   	 }
			 if(paym == 3){
// 		   		 alert("3개월 결제입니다.");
<%-- 		   		$('#totalPrice').val(<%=cvo.getClass_price()%>*3); --%>
		   		$('#totalPrice').val(Math.ceil(<%=cvo.getClass_price()%>*3 *0.95 / 100)*100);
<%-- 		   		<%=totalPrice=Integer.parseInt(cvo.getClass_price())*3 %>; --%>
		   	 }
			 if(paym == 6){
// 		   		 alert("6개월 결제입니다.");
		   		$('#totalPrice').val(Math.ceil(<%=cvo.getClass_price()%>*6 *0.9 / 100)*100);
...
<!-- 		  <div class="button">Next</div> -->
        ...
        <fieldset class="section">
        <h3 onclick="putvalue()">KakaoPay </h3>
          <input type="text" name="name" id="name" placeholder="Name">
          <input type="text" name="email" id="email" placeholder="Email">
          <input type="text" name="phone" id="phone" placeholder="phone">
          <input type="text" name="address" id="address" placeholder="address">
