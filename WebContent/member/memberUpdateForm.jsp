...
<!--       <div class="panel text-center" style="border:none;"> -->
        <div class="panel-body" style="border:none;background:#faf8f0;font-size:1.2em;">
          <p><label style="width:20%;">이름: </label><input class="updateMydata" type="text" name="mem_name" value="<%=memVo.getMem_name()%>"></p>
          <hr>
          <p><label style="width:20%;">비밀번호: </label><input class="updateMydata" type="password" name="mem_pass" value="<%=memVo.getMem_pass()%>"></p>
          <hr>
          <p><label style="width:20%;">닉네임: </label><input class="updateMydata" type="text" name="mem_nickname" value="<%=memVo.getMem_nickname()%>"></p>
          <hr>
          <p><label style="width:20%;">전화번호: </label><input class="updateMydata" type="text" name="mem_tel" value="<%=memVo.getMem_tel()%>"></p>
          <hr>
          <p><label style="width:20%;">주소: </label><input class="updateMydata" type="text" name="mem_add" value="<%=memVo.getMem_add()%>"></p>
          <hr>
          <p><label style="width:20%;">이메일: </label><input class="updateMydata" type="text" name="mem_email" value="<%=memVo.getMem_email()%>"></p>
          <hr>
