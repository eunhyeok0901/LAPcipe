...
public class ClassReviewDaoImpl implements IClassReviewDao {
	...
	public String getReviewCon(ClassReviewVO vo) {
		...
		try {
			reviewCon = (String) client.queryForObject("classreview.getReviewCon",vo);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public int insertNewCon(ClassReviewVO vo) {
		...
		try {
			count = client.update("classreview.insertNewCon",vo);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public int deleteReview(String con) {
		...
		try {
			count = client.delete("classreview.deleteReview",con);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
